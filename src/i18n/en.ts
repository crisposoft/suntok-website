...
export const en: TranslationKeys = {
  ...
  contactPage: {
    ...
    faq: {
      ...
      a1: 'SuntOK is free for basic use! If you want extra features like multiple emergency contacts, custom messages, and flexible check-in frequency, you can upgrade to Premium for just 10 RON/year.',
